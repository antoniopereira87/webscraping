...
conexao = sql.connect(user='root', database='BRASILEIRAO', host='localhost', port='3306', password='senha')
...
add_jogador = ("INSERT INTO JOGADOR VALUES"
               "(%s, %s, %s, %s)")
try:
    ...
    print("Tabela JOGADOR já criada")
...
add_partida = ("INSERT INTO PARTIDA VALUES"
               "(%s, %s, %s, %s, %s, %s)")
...
try:
    ...
    print("PARTIDA já criada")

# Preenchendo tabela GOLS
# np, j, tg, mg, tm
# np, c, a, m, n, c, id
add_gols = ("INSERT INTO GOLS VALUES"
               "(%s, %s, %s, %s, %s)")
